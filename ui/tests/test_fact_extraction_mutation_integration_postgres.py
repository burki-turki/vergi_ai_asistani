...
try:
    ...
    # ============================================================
    # B7 - RECONCILIATION merged registry - 49 routing keys, real
    #      operator-factory construction (no fake injection).
    # ============================================================
    merged_registry_b7 = op._default_registry_factory()
    check(
        "B7 merged reconciliation registry has exactly 49 routing keys "
        ...
        len(merged_registry_b7.known_action_families()) == 49,
