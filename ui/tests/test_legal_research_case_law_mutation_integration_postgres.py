...
try:
    ...
    # ============================================================
    # B12 - RECONCILIATION merged registry - 47 routing keys, real
    #       operator-factory construction (no fake injection).
    # ============================================================
    merged_registry_b12 = op._default_registry_factory()
    check(
        "B12 merged reconciliation registry has exactly 47 routing keys (10 approval + 24 review "
        ...
        len(merged_registry_b12.known_action_families()) == 47,
