...
GENERATION_ACTION_FAMILY = "generation.risk_strategy"
...
def get_reviews_dir(case_id):
    ...
    return get_risk_strategy_dir(case_id) / "generation_reviews"


def get_target_ref():

    return "risk_strategy.pending"
...
def write_pending(
    ...
    *,
    ...
    AYNI additive/keyword-only/legacy-preserving gerekçesi. `risk_
    strategy_engine.py`'nin KENDİ `write_carry_forward_audit()`'i
...
def main():
    ...
    # generation --row-key risk_strategy ...` üzerinden yaşar. Aşağıdaki
